...
TW.cameraSetup(renderer,scene, {minx: -guiParams.ballRadius, maxx: guiParams.ballRadius,
...
gui.add(guiParams,"maxBallHeight",1,30).step(1);
gui.add(guiParams,"maxBallHeight",1,30).step(1);
gui.add(guiParams,"ballVelocityX",0,5).step(0.2);
